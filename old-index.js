...
function hoverTags(fromLS) {
    // JSON.parse(localStorage.getItem('gifsTendencia'))
    let objTrend=fromLS;
    for (i = 0; i < 10; i++) {
        var ctrlId = 'tag-1' + i;
        if (document.getElementById(ctrlId))
